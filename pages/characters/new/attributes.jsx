...
const Attributes = () => {
	...
	return <Layout title="3: Attributes">
		...
		<Attribute onChange={ setAttribute('Control') } value={ character.attributes.Control } title="Control">Control is about physical dexterity, coordination, accuracy and control.</Attribute>
		<Attribute onChange={ setAttribute('Strength') } value={ character.attributes.Strength } title="Strength">Strength is all about physical strength, power, force and endurance.</Attribute>
		<Attribute onChange={ setAttribute('Focus') } value={ character.attributes.Focus } title="Focus">Focus is all about thinking, mental reasoning, emotional restraint, and concentrating.</Attribute>
		<Attribute onChange={ setAttribute('Passion') } value={ character.attributes.Passion } title="Passion">Passion is all about determination, mental force, emotional strength and imagination.</Attribute>
